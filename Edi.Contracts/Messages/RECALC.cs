...
public class RECALC
{
	...
	/// SG1
	/// </summary>
	public List<RECALC_SG1>? SG1M { get; set; }
	...
	/// SG2
	/// </summary>
	public List<RECALC_SG2>? SG2M { get; set; }
...
public class RECALC_SG2 : REL
{
	...
	/// SG3
	/// </summary>
	public List<RECALC_SG3>? SG3M { get; set; }
...
public class RECALC_SG3 : ARD
{
	...
	/// SG4
	/// </summary>
	public List<RECALC_SG4>? SG4M { get; set; }
...
public class RECALC_SG4 : MOA
{
	...
	/// SG5
	/// </summary>
	public List<RECALC_SG5>? SG5C { get; set; }

	/// <summary>
	/// SG6
	/// </summary>
	public RECALC_SG6? SG6C { get; set; }

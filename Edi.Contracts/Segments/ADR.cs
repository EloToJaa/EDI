...
public class ADR
{
	...
	/// </summary>
	[EdiValue("X(35)", Path = "ADR/2")]
	public string? CityName { get; set; }

	/// <summary>
	/// Code defining postal zones or addresses.
	/// </summary>
	[EdiValue("X(9)", Path = "ADR/3")]
